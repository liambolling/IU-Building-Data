...
class Filter_View: UIView, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if String(describing: (mapData[indexPath.row] as! NSManagedObject).value(forKey: "bld_code")!) != "" {
            cell.detailTextLabel?.text = "BLDG: "+String(describing: (mapData[indexPath.row] as! NSManagedObject).value(forKey: "bld_code")!)
        }
