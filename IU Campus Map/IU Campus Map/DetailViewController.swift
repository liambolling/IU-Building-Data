...
class DetailViewController: UIViewController, UIScrollViewDelegate {
    ...
    func createTransportOptions(whiteBackground: UIView){
        ...
        walking_button.addTarget(self, action: #selector(openInMaps_walking), for: .touchUpInside)
        ...
        running_button.addTarget(self, action: #selector(openInMaps_walking), for: .touchUpInside)
        ...
        drive_button.addTarget(self, action: #selector(openInMaps_driving), for: .touchUpInside)
    ...
    func openInMaps_walking(){
        ...
        //TODO: Add option for Google Maps?
//        if (UIApplication.shared.canOpenURL(URL(string:"comgooglemaps://")!)) {
//            var queryString = "comgooglemaps://?daddr="+String(self.buildingGeo.latitude)+","
//            queryString+=String(self.buildingGeo.longitude)+"&directionsmode=walking"
